...
image(X, main="Heat Map of All Values", axes=FALSE) # if you wish to have a heat mao of how the data is spread
...
image(X, col=heat.colors(1), main="Heat Map showing missing values", axes=FALSE) # Only the spread of misisng vlaues

par(mfrow=c(1,1))

write.csv(X,"MCAR_Dataset.csv", row.names=FALSE, col.names=FALSE)